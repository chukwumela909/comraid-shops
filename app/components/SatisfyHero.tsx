...
const newArrivals: ProductItem[] = [
  {
    ...
    price: "170 EUR",
    colors: ["#2D2D2D"],
    front: "https://satisfyrunning.com/cdn/shop/files/11017-RRRockyRoad_PS1_702x562_crop_center.jpg",
    back: "https://satisfyrunning.com/cdn/shop/files/11017-RRRockyRoad_PS2_1053x843.jpg",
  },
  {
    id: 2,
    ...
    front: "https://satisfyrunning.com/cdn/shop/files/11004-FA-SA_space-o-singlet_falcon_front_702x562_crop_center.jpg",
    back: "https://satisfyrunning.com/cdn/shop/files/11004-FA-SA_space-o-singlet_falcon_back_702x562_crop_center.jpg",
  },
  {
    id: 3,
      ...
      <nav className="absolute  left-0 right-0 z-10">
        <div className="flex items-center py-4 px-8 md:px-12">
          <div className="flex items-center space-x-12">
            <Image
              src="/images/comraid-logo.png"
              alt="Comraid Shops Logo"
              width={120}
              height={60}
              priority
        ...
        <div className="w-full">
          ...
          <div className="hidden md:block">
            <div className="grid grid-cols-4 gap-12 mx-auto px-8">
              {["12043-DM_Space-O5Shorts_DeepMahogany_1.jpg","11043-MD-SA-Mineral_Dune-001__2670px_1.jpg","12028-OL-Olive-001_2670px.jpg","11006-AB-OF-AgedBlack-001_2670px.jpg"].map((img, idx) => (
                <div key={idx} className="group cursor-pointer">
                  <div className="relative overflow-hidden bg-gray-50">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={`https://satisfyrunning.com/cdn/shop/files/${img}`} alt={`Silhouette product ${idx + 1}`} className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-105" />
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-[70vh]">
          ...
          <div className="bg-[#baafa4] rounded-lg flex flex-col justify-center items-center p-8 lg:p-16 min-h-[400px] lg:min-h-[70vh]">
            <div className="w-full max-w-lg text-center">
              <h2 className="text-4xl md:text-5xl font-walter font-extrabold mb-6 tracking-tight text-white">
                Get on the list
              </h2>
              <p className="text-base md:text-lg font-simon mb-12 text-white leading-relaxed">
              ...
              <form className="mb-8">
                <div className="flex items-end border-b-2 border-white pb-1">
                  <input 
                    ...
                    className="flex-1 bg-transparent text-white placeholder-white/70 font-simon text-base focus:outline-none mr-4"
              ...
              <p className="text-xs font-simon text-white/70 leading-relaxed">
