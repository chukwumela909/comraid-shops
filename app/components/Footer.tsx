      ...
      <div className=" mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-6  mb-16">
          ...
          <div className="md:col-span-3">
            <h3 className="text-xl font-walter font-bold mb-2 text-black">SATISFY</h3>
        ...
        <div className=" border-gray-300 ">
          <div className="flex flex-col md:flex-row justify-end items-center">
            <div className="flex space-x-6">
              <a href="#" className="text-xs font-simon text-gray-600 hover:text-black transition-colors">©2025 SATISFY®</a>
